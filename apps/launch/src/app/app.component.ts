...
@Component({
  standalone: true,
  imports: [NxWelcomeComponent, RouterModule, FeaturesDirective, CommonModule, MatToolbarModule],
  selector: 'launch-darkly-angular-root',
  template: `
    <mat-toolbar>
      <ul style="display: flex; justify-content: space-around; gap: 12px; width: 100%;">
...
export class AppComponent {
  menuitems = [
    { path: '/', label: 'Home' },
    { path: '/learning', label: 'Learning', feature: 'show-learning-materials' },
